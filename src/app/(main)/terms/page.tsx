  ...
  return (
    <div className="container py-12 md:py-20">
      <div className="prose prose-lg dark:prose-invert mx-auto max-w-4xl">
        ...
        <p>
          We grant you a limited, non-exclusive, non-transferable, revocable license to use Desk Assistant AI ("the application") for your personal or internal business purposes, subject to these terms. You agree not to reverse-engineer, decompile, or otherwise attempt to discover the source code of the application.
        </p>
        ...
        <p>
          To the fullest extent permitted by law, in no event will Desk Assistant AI, its developers, or affiliates be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from (a) your access to or use of or inability to access or use the application; (b) any unauthorized access to or use of our servers and/or any personal information stored therein; or (c) any action taken on your files by the application upon your approval. Our total liability for any claim arising out of these terms or the use of the application will not exceed the amount you paid us, if any, to use the application.
        </p>
